# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-08 17:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie_rating_relations.Movie')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie_rating_relations.Rater')),
            ],
        ),
    ]
